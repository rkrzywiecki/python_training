...
# %%
stocks_with_len_5 = [company for company in wig20_names if len(company) == 5]
# %%
stock_with_P = [company for company in wig20_names if company.startswith("P")]
# %%
stock_with_E = [company for company in wig20_names if company.endswith("P")]
# %%
